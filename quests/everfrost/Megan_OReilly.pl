...
sub EVENT_ITEM {
	...
	if (plugin::check_handin(\%itemcount, 13244 => 1)) {
        ...
        quest::ding();
		quest::exp(2500);
		# 213 : Faction Merchant's of Halas
		quest::faction(213,10);
		# 294 : Faction Shaman of Justice
		quest::faction(294,10); 
		# 311 : Faction Steel Warriors
		quest::faction(311,10);	
		# 361 : Faction Wolves of the North
		quest::faction(361,10); 
		# 13245 :  Empty Bottle of Elixir
