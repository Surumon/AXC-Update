...
sub EVENT_SAY {
	if ($text=~/Hail/i){
	quest::say("You best be here for training or I will have your tongue! If you are here to learn the ways of the Enchanter, read the note in your inventory and then hand it to me so we can begin.  If you are not an Enchanter, then do not waste my time!");
	}
 if ($text=~/trades/i) {
...
quest::say("I don't need these. Here, $name take them back.");
}
}
