#Fixed by Surumon May 5 2015 - DE WAR Trainer
#Lifted the code from a repository kept by caved at https://code.google.com/p/projecteqquests/source/browse/trunk/quests/neriakb/Seloxia_Punox.pl?r=1114
...
# Sealed Letter (Letter To Seloxia)
