#Fixed by Surumon May 9 2015 - Added missing hand in dialogue (Made Up).
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 28062 => 2, 28061 => 2)){
    ...
    quest::say("Aye. Aye. Dis'll do. My alchemist shall be able to use these to learn much about our foe.  Well done, you have earned this.");
